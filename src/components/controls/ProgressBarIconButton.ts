...
@customElement('lumina-progress-bar-icon-button')
export class ProgressBarIconButton extends LitElement {
    ...
    private _palette() {
        ...
        let progress = 'var(--md-sys-color-primary, #6750a4)';

        switch (this.buttonType) {
            case 1:
                bg = 'var(--md-sys-color-primary, #6750a4)';
                fg = 'var(--md-sys-color-on-primary, #ffffff)';
                progress = 'var(--md-sys-color-on-primary, #ffffff)';
                break;
            case 2:
    ...
    render() {
        ...
        return html`
            <button
                ...
                style="
                    --pb-icon-btn-size:${sizePx}px;
                    --pb-bg:${p.bg};
                    --pb-fg:${p.fg};
                    --pb-border:${p.border};
                    --pb-progress:${p.progress};
                    --pb-icon-size:${iconPx}px;
...
declare global {
    interface HTMLElementTagNameMap {
        'lumina-progress-bar-icon-button': ProgressBarIconButton;
    }
}

...
export class FloatingActionTimeButton extends LitElement {
    ...
    render() {
        ...
        const timerPx = Math.max(12, Math.floor(iconSize * 0.65));
        ...
        return html`
            <button
                ...
                style="
                    --tb-fab-size:${this.fabSize}px;
                    --tb-fab-radius:${radius}px;
            ...
            >
                ...
                <span class="content">
                    ${this._locked
                        ? html`<span class="timer" style="font-size:${timerPx}px">${this._formatTimer(this._remaining)}</span>`
